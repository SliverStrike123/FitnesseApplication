          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                width: 200,
                child: Image.asset('assets/fitnesselogo.jpg'),
              ),
              Card(
                        ...
                        children: [
                          ...
                          TextFormField(
                            ...
                            validator: (value) {
                              ...
                              (value.toLowerCase().contains("admin") || value.toLowerCase().contains("trainer") )){
                                return 'Sorry, you are unable to use "admin" or "trainer" words';
                              }
                              return null;
                            },
                            onSaved: (value) {
